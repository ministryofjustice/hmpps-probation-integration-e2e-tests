...
- complementary:
  ...
  - link "X917556":
    - /url: "#"
  - text: "PNC: 2000/3611648D Name:"
  - link "Luke Jacobi":
    - /url: "#"
  - text: "(Male) D.O.B: 04/12/2000 (24) Community Manager: (RO)"
  - link "Unallocated":
    - /url: "#"
  - text: "- Unallocated Team(N50), Greater Manchester Prison Manager:"
  - link "Unallocated":
    - /url: "#"
  - text: "- All Staff,"
  - link "Swansea (HMP)":
  ...
  - link "D_0":
    - /url: "#"
  - text: " Event: 1. Adult Custody < 12m (6 Months) for Aiding suicide Expected Sentence End Date: 10/11/2025 Order Manager: Unallocated - NPS GCS Stroud, NPS South West and South Central In Custody - RoTL: 12/05/2025"
- navigation:
  - list:
    - listitem:
      - link " Home":
