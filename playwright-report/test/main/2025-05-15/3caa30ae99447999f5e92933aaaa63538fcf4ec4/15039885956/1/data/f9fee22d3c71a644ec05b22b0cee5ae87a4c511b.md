...
- complementary:
  ...
  - link "X918163":
    - /url: "#"
  - text: "PNC: 1959/3831524X Name:"
  - link "Evelyn Kerluke":
    - /url: "#"
  - text: "(Female) D.O.B: 26/04/1959 (66) Community Manager: (RO)"
  - link "Unallocated":
    - /url: "#"
  ...
  - link "D_0":
    - /url: "#"
  - text: " Event: 1. Adult Custody < 12m (6 Months) for Authorising failure to keep proper accounting records Expected Sentence End Date: 13/11/2025 Order Manager: Unallocated - OMU A , NPS North East Released - On Licence: 14/05/2025"
- navigation:
  - list:
    - listitem:
      - link " Home":
...
- main:
  ...
  - button ""
  - textbox "Imposed (Release) Date:*": 14/05/2025
