...
- complementary:
  ...
  - link "X926757":
    - /url: "#"
  - text: "PNC: 2002/9117717R Name:"
  - link "Bridget Gutkowski":
    - /url: "#"
  - text: "(Female) D.O.B: 30/07/2002 (22) Community Manager: (RO)"
  - link "Unallocated":
    - /url: "#"
  ...
  - link "D_0":
    - /url: "#"
  - text: " Event: 1. Adult Custody < 12m (6 Months) for Burglary (non dwelling) with intent to commit, or the commission of an offence triable only on indictment Expected Sentence End Date: 03/12/2025 Order Manager: Unallocated - OMU A , NPS North East Released - On Licence: 04/06/2025"
- navigation:
  - list:
    - listitem:
      - link " Home":
...
- main:
  ...
  - button ""
  - textbox "Imposed (Release) Date:*": 04/06/2025
