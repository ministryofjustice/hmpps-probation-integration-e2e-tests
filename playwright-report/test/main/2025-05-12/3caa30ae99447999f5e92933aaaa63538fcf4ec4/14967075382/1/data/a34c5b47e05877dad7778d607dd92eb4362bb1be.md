...
- complementary:
  ...
  - link "X915342":
    - /url: "#"
  - text: "PNC: 2003/3405391G Name:"
  - link "Terrance Reinger":
    - /url: "#"
  - text: "(Male) D.O.B: 09/09/2003 (21) Community Manager: (RO)"
  - link "Unallocated":
    - /url: "#"
  ...
  - link "D_0":
    - /url: "#"
  - text: " Event: 1. Adult Custody < 12m (6 Months) for Class A - Cocaine - Having possession of Expected Sentence End Date: 09/11/2025 Order Manager: Unallocated - OMU A , NPS North East Released - On Licence: 11/05/2025"
- navigation:
  - list:
    - listitem:
      - link " Home":
...
- main:
  ...
  - button ""
  - textbox "Imposed (Release) Date:*": 11/05/2025
