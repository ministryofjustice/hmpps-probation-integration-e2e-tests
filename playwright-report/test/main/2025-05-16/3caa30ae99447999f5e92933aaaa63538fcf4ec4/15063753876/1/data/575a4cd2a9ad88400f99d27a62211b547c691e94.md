...
- complementary:
  ...
  - link "X918262":
    - /url: "#"
  - text: "PNC: 1981/3678418M Name:"
  - link "Emmett Renner":
    - /url: "#"
  - text: "(Male) D.O.B: 24/01/1981 (44) Community Manager: (RO)"
  - link "Unallocated":
    - /url: "#"
  ...
  - link "D_0":
    - /url: "#"
  - text: " Event: 1. Adult Custody < 12m (6 Months) for Other offence against the Labour Laws Expected Sentence End Date: 13/11/2025 Order Manager: Unallocated - OMU A , NPS North East Released - On Licence: 15/05/2025"
- navigation:
  - list:
    - listitem:
      - link " Home":
...
- main:
  ...
  - button ""
  - textbox "Imposed (Release) Date:*": 15/05/2025
