...
- complementary:
  ...
  - link "X928927":
    - /url: "#"
  - text: "PNC: 1966/7993354G Name:"
  - link "Stanley Thiel":
    - /url: "#"
  - text: "(Male) D.O.B: 09/03/1966 (59) Community Manager: (RO)"
  - link "Unallocated":
    - /url: "#"
  ...
  - link "D_0":
    - /url: "#"
  - text: " Event: 1. Adult Custody < 12m (6 Months) for Obstruction or failure to comply with authorised officer Expected Sentence End Date: 11/12/2025 Order Manager: Unallocated - OMU A , NPS North East Released - On Licence: 12/06/2025"
- navigation:
  - list:
    - listitem:
      - link " Home":
...
- main:
  ...
  - button ""
  - textbox "Imposed (Release) Date:*": 12/06/2025
