...
- Name: View probation documents in Prisoner Profile System
- Location: /_work/hmpps-probation-integration-e2e-tests/hmpps-probation-integration-e2e-tests/tests/prisoner-profile-and-delius/view-documents.spec.ts:15:1
...
Call log:
  ...
  - waiting for locator(':root')
    ...
    at /_work/hmpps-probation-integration-e2e-tests/hmpps-probation-integration-e2e-tests/tests/prisoner-profile-and-delius/view-documents.spec.ts:28:5
```
