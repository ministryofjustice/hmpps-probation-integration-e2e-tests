...
- Name: View Community manager details
- Location: /_work/hmpps-probation-integration-e2e-tests/hmpps-probation-integration-e2e-tests/tests/prison-education-and-delius/view-community-manager.spec.ts:18:1
...
Call log:
  ...
  - waiting for locator(':root')
    ...
    at /_work/hmpps-probation-integration-e2e-tests/hmpps-probation-integration-e2e-tests/tests/prison-education-and-delius/view-community-manager.spec.ts:32:5
```
