...
- complementary:
  ...
  - link "X920839":
    - /url: "#"
  - text: "PNC: 1983/1494961V Name:"
  - link "Marc Hartmann":
    - /url: "#"
  - text: "(Male) D.O.B: 21/01/1983 (42) Community Manager: (RO)"
  - link "Unallocated":
    - /url: "#"
  ...
  - link "D_0":
    - /url: "#"
  - text: " Event: 1. Adult Custody < 12m (6 Months) for Cause serious injury by careless driving Expected Sentence End Date: 24/11/2025 Order Manager: Inactive - Inactive, External - Wales In Custody - RoTL: 26/05/2025"
- navigation:
  - list:
    - listitem:
      - link " Home":
...
- main:
  ...
  - button ""
  - textbox "Imposed (Release) Date:*": 26/05/2025
