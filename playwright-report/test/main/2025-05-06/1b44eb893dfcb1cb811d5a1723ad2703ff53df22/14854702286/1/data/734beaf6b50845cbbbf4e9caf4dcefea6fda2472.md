...
Call log:
  ...
  - attempting select option action
    ...
    at /_work/hmpps-probation-integration-e2e-tests/hmpps-probation-integration-e2e-tests/tests/tier-to-delius/update-tier.spec.ts:19:5
```
...
- complementary:
  ...
  - link "X904546":
    - /url: "#"
  - text: "PNC: 2007/5506110H Name:"
  - link "Glen Batz":
    - /url: "#"
  - text: "(Male) D.O.B: 18/01/2007 (18) Community Manager:"
  - link "Unallocated":
    - /url: "#"
  - text: "- Unallocated Team(N57), Kent Surrey Sussex Region Tier:"
  - link "D_0":
    - /url: "#"
- navigation:
  - list:
