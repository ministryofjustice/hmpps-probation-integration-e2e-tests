...
- complementary:
  ...
  - link "X910282":
    - /url: "#"
  - text: "PNC: 1988/7374863U Name:"
  - link "Whitney Sanford":
    - /url: "#"
  - text: "(Female) D.O.B: 17/03/1988 (37) Community Manager: (RO)"
  - link "Unallocated":
    - /url: "#"
  ...
  - link "Swansea (HMP)":
    - /url: "#"
  - text: " Event: 1. Adult Custody < 12m (6 Months) for Stealing from automatic machines and meters Expected Sentence End Date: 05/11/2025 Order Manager: Unallocated - Default Designated Transfer Team, NPS Midlands In Custody - RoTL: 07/05/2025"
- navigation:
  - list:
    - listitem:
      - link " Home":
...
- main:
  ...
  - button ""
  - textbox "Imposed (Release) Date:*": 07/05/2025
