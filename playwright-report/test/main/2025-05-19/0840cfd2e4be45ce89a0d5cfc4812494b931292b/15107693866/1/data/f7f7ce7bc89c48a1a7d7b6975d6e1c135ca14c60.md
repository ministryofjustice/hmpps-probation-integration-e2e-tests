...
- complementary:
  ...
  - link "X918819":
    - /url: "#"
  - text: "PNC: 1974/5207227E Name:"
  - link "Ernesto Bechtelar":
    - /url: "#"
  - text: "(Male) D.O.B: 11/09/1974 (50) Community Manager: (RO)"
  - link "Unallocated":
    - /url: "#"
  ...
  - link "D_2":
    - /url: "#"
  - text: " Event: 1. Adult Custody < 12m (6 Months) for Disclosing restricted information Expected Sentence End Date: 16/11/2025 Order Manager: Unallocated - OMU A , NPS North East Released - On Licence: 18/05/2025"
- navigation:
  - list:
    - listitem:
      - link " Home":
...
- main:
  ...
  - button ""
  - textbox "Imposed (Release) Date:*": 18/05/2025
  ...
  - combobox "Provider:*":
    ...
    - option "South West"
    - option "Wales"
    - option "West Midlands Region" [selected]
  ...
  - combobox "Team:":
    ...
    - option "Inactive Team(N52)"
    - option "Tiering Service"
    - option "Unallocated Team(N52)"
  - text: "Officer:"
  - combobox "Officer:":
    - option "[Please Select]" [selected]
  - text: "Notes:"
