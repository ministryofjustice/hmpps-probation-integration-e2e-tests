...
- complementary:
  ...
  - link "X904489":
    - /url: "#"
  - text: "PNC: 1990/2551172G Name:"
  - link "Robyn Schowalter":
    - /url: "#"
  - text: "(Female) D.O.B: 19/06/1990 (34) Community Manager: (RO)"
  - link "Unallocated":
    - /url: "#"
  - text: "- Unallocated Team(N04), NPS Midlands Prison Manager:"
  - link "Unallocated":
    - /url: "#"
  - text: "- All Staff,"
  - link "Swansea (HMP)":
  ...
  - link "D_0":
    - /url: "#"
  - text: " Event: 1. Adult Custody < 12m (6 Months) for Manufacture or possession of explosives under suspicious circumstances Expected Sentence End Date: 02/11/2025 Order Manager: Unallocated - Automated Allocation Team, West Midlands Region In Custody - RoTL: 04/05/2025"
- navigation:
  - list:
    - listitem:
      - link " Home":
...
- main:
  ...
  - button ""
  - textbox "Imposed (Release) Date:*": 04/05/2025
  ...
  - combobox "Provider:*":
    ...
    - option "Kent Surrey Sussex Region" [selected]
    - option "London"
  ...
  - combobox "Team:":
    ...
    - option "Inactive Team(N57)"
    - option "Tiering Service"
    - option "Unallocated Team(N57)"
  - text: "Officer:"
  - combobox "Officer:":
    - option "[Please Select]" [selected]
  - text: "Notes:"
