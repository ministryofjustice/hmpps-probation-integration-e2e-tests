...
- complementary:
  ...
  - link "X927644":
    - /url: "#"
  - text: "PNC: 1992/5221004D Name:"
  - link "Roman Roberts":
    - /url: "#"
  - text: "(Male) D.O.B: 26/12/1992 (32) Community Manager: (RO)"
  - link "Unallocated":
    - /url: "#"
  ...
  - link "D_0":
    - /url: "#"
  - text: " Event: 1. Adult Custody < 12m (6 Months) for Stealing from the person of another Expected Sentence End Date: 07/12/2025 Order Manager: Unallocated - OMU A , NPS North East Released - On Licence: 09/06/2025"
- navigation:
  - list:
    - listitem:
      - link " Home":
...
- main:
  ...
  - button ""
  - textbox "Imposed (Release) Date:*": 09/06/2025
