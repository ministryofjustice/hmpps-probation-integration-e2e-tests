...
export const verifyRecallOffenderDetails = async ( page: Page, crnInDelius: string, dobInDelius: Date, genderInDelius: string): Promise<void> => {
...
export const verifyRecallOffendersAddress = async (page: Page, street: string, city: string, postcode: string): Promise<void> => {
