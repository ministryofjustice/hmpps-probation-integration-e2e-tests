...
export const verifyRoSHSummaryIsAsPerOASys = async (page: Page) => {
    ...
    await expect(page.getByLabel('When is the risk likely to be the greatest')).toHaveText(
    ...
    await expect(page.getByLabel('What circumstances are likely to increase risk')).toHaveText(
