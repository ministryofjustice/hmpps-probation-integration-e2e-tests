...
export const verifyRiskToSelfIsAsPerOASys = async (page: Page) => {
    await page.locator('a', { hasText: 'Risk to self' }).click()
    ...
    await expect(page.getByLabel('Current concerns about Coping in Custody or Hostel')).toHaveText(
    ...
    await expect(page.getByLabel('Current concerns about Vulnerability')).toHaveText(
