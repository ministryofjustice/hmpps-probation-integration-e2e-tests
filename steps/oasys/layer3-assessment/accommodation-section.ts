...
export const complete3AccommodationSection = async (page: Page) => {
    ...
    await page.getByLabel('Suitability of location of accommodation').selectOption({ label: '0-No problems' })
    await page.fill(
        '#textarea_3_97',
    ...
    await page.getByLabel('Accommodation issues linked to offending behaviour').selectOption({ label: 'No' })
