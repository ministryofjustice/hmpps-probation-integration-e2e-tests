...
export const completeRoSHSection10RoSHSummary = async (page: Page, highRoshScore: boolean = false) => {
    ...
    if (highRoshScore) {
        ...
        await page.locator('#itm_SUM6_1_1').selectOption({ label: 'N' })
        await page.locator('#itm_SUM6_2_1').selectOption({ label: 'N' })
        await page.locator('#itm_SUM6_3_1').selectOption({ label: 'N' })
        await page.locator('#itm_SUM6_4_1').selectOption({ label: 'N' })
        await page.locator('#itm_SUM6_1_2').selectOption({ label: 'N' })
        await page.locator('#itm_SUM6_2_2').selectOption({ label: 'N' })
        await page.locator('#itm_SUM6_3_2').selectOption({ label: 'N' })
        await page.locator('#itm_SUM6_4_2').selectOption({ label: 'N' })
        await page.locator('#itm_SUM6_5_2').selectOption({ label: 'N' })
    }
