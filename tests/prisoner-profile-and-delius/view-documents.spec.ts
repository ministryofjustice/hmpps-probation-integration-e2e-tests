...
test('View probation documents in Prisoner Profile System', async ({ page }) => {
    ...
    await dpsLogin(page)
    await page.goto(`${process.env.PRISONER_PROFILE_URL}/prisoner/${nomisId}/probation-documents`)
